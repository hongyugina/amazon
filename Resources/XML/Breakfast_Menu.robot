...
*** Variables ***
${XML_MENU_PATH} =  inputs/xml/samples/menu.xml
${EXPECTED_MENU_COUNT} =  1
${EXPECTED_FOOD_COUNT} =  4
...
Verify First Food Name
    #  I would have tought I need to pass breakfast_menu/food[1]/name
    #  but that is ot the case. Only pass the name of the dsired element
...
Verify First Food Calories
    ...
    Should Be Equal As Strings    ${first_food_calories.text}   600    
